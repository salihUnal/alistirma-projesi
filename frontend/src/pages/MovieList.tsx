...
function MovieList({ onBack }: TestPageProps) {
  ...
  const renderContent = () => {
    switch (currentPage) {
      case "Filmler":
        return (
          <div className="border-hidden border-blue-200 dark:border-blue-700  bg-white dark:bg-gray-800 p-6 mt-10 rounded-lg shadow-blue-500 shadow-xl  ">
            <div className="mb-1">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white/70 dark:bg-slate-900/70 backdrop-blur border-b border-slate-200/60 dark:border-slate-700/60 rounded-lg">
        ...
        >
          <img
            ...
            // role="button"
            // onClick={() => navigate("/movies/Tumu")}
          />
          <span
            className=" text-lg font-semibold sm:text-lg md:text-md lg:text-lg xl:text-xl 2xl:text-2xl text-slate-800 dark:text-slate-100"
            role="button"
            // onClick={() => navigate("/movies/Tumu")}
          >
            Film Uygulaması
